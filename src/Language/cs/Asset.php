...
return [
    'exception' => [
        ...
        'cannot_write_to_storage' => 'Nelze zapsat soubor na úložný disk "{storage}" do cesty "{path}". Důvod: {reason}',
        ...
        'pending_asset_not_found' => 'Čekající prostředek s ID "{id}" nebyl nalezen.',
    ],
];
