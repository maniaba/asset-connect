...
return [
    'exception' => [
        ...
        'cannot_write_to_storage' => 'No se puede escribir el archivo en el disco de almacenamiento "{storage}" en la ruta "{path}". Motivo: {reason}',
        ...
        'pending_asset_not_found' => 'No se encontró el recurso pendiente con ID "{id}".',
    ],
];
