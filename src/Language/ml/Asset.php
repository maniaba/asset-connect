...
return [
    'exception' => [
        ...
        'cannot_write_to_storage' => 'സ്റ്റോറേജ് ഡിസ്ക് "{storage}" ലെ "{path}" പാതയിൽ ഫയൽ എഴുതാൻ കഴിയില്ല. കാരണം: {reason}',
        ...
        'pending_asset_not_found' => 'ID "{id}" ഉള്ള തീർപ്പാകാത്ത അസറ്റ് കണ്ടെത്തിയില്ല.',
    ],
];
