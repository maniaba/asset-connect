...
return [
    'exception' => [
        ...
        'cannot_write_to_storage' => 'لا يمكن كتابة الملف إلى قرص التخزين "{storage}" في المسار "{path}". السبب: {reason}',
        ...
        'pending_asset_not_found' => 'لم يتم العثور على الأصل المعلق بالمعرّف "{id}".',
    ],
];
