...
return [
    'exception' => [
        ...
        'cannot_write_to_storage' => 'Неможливо записати файл на диск сховища "{storage}" за шляхом "{path}". Причина: {reason}',
        ...
        'pending_asset_not_found' => 'Очікуваний ресурс з ID "{id}" не знайдено.',
    ],
];
