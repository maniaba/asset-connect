...
return [
    'exception' => [
        ...
        'cannot_write_to_storage' => 'স্টোরেজ ডিস্ক "{storage}"-এ "{path}" পাথে ফাইল লেখা যাচ্ছে না। কারণ: {reason}',
        ...
        'pending_asset_not_found' => 'ID "{id}" সহ মুলতুবি অ্যাসেটটি পাওয়া যায়নি।',
    ],
];
