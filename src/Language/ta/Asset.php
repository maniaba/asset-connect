...
return [
    'exception' => [
        ...
        'cannot_write_to_storage' => 'சேமிப்பு வட்டு "{storage}" இல் "{path}" பாதையில் கோப்பை எழுத முடியாது. காரணம்: {reason}',
        ...
        'pending_asset_not_found' => 'ID "{id}" கொண்ட நிலுவையிலுள்ள asset கிடைக்கவில்லை.',
    ],
];
