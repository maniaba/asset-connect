...
return [
    'exception' => [
        ...
        'cannot_write_to_storage' => 'Невозможно записать файл на диск хранилища "{storage}" по пути "{path}". Причина: {reason}',
        ...
        'pending_asset_not_found' => 'Ожидающий ресурс с ID "{id}" не найден.',
    ],
];
