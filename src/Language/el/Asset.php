...
return [
    'exception' => [
        ...
        'cannot_write_to_storage' => 'Δεν είναι δυνατή η εγγραφή του αρχείου στον δίσκο αποθήκευσης "{storage}" στη διαδρομή "{path}". Αιτία: {reason}',
        ...
        'pending_asset_not_found' => 'Το εκκρεμές asset με ID "{id}" δεν βρέθηκε.',
    ],
];
