...
return [
    'exception' => [
        ...
        'cannot_write_to_storage' => 'Nije moguće zapisati datoteku na storage disk "{storage}" na putanji "{path}". Razlog: {reason}',
        'database_error'          => 'Došlo je do greške prilikom čuvanja sredstva u bazi podataka: {errors}',
