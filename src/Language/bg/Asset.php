...
return [
    'exception' => [
        ...
        'cannot_write_to_storage' => 'Не може да се запише файл в диска за съхранение "{storage}" на път "{path}". Причина: {reason}',
        ...
        'pending_asset_not_found' => 'Чакащият актив с ID "{id}" не беше намерен.',
    ],
];
