...
return [
    'exception' => [
        ...
        'cannot_write_to_storage' => 'Não é possível escrever o ficheiro no disco de armazenamento "{storage}" no caminho "{path}". Motivo: {reason}',
        ...
        'pending_asset_not_found' => 'O ativo pendente com ID "{id}" não foi encontrado.',
    ],
];
