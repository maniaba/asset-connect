...
return [
    'exception' => [
        ...
        'cannot_write_to_storage' => 'Kan inte skriva filen till lagringsdisken "{storage}" på sökvägen "{path}". Orsak: {reason}',
        ...
        'pending_asset_not_found' => 'Den väntande tillgången med ID "{id}" hittades inte.',
    ],
];
