...
trait UrlGeneratorTrait
{
    ...
    /**
     * Get the relative URL for this asset, which is the path without the scheme and host.
     *
     * @param string|null $variantName   The name of the variant to get the URL for, or empty for the original asset
    ...
    {
        return $this->toRelativeUrl($this->getUrl($variantName, $forceDownload));
    }
    ...
    {
        return $this->toRelativeUrl($this->getTemporaryUrl($expiration, $variantName, $forceDownload));
    }
